...
The underlay routing process enablesreachability between loopback addresses on each device. BGP, OSPF or ISIS would be the most commonly used. In our example here, we will use BGP.
